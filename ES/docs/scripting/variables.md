# Variables
Las variables pueden pensarse como contenedores con nombre que pueden contener un valor.
...
Nota que para incrementar `i`, lo establecemos en su propio valor más `1`. Cambiar el valor de una variable basado en su valor previo es algo muy común.
