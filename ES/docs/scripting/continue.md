...
`continue` permite detener la iteración actual de un bucle y pasar a la siguiente iteración del bucle más interno.

`for i in range(10):
	continue
    print("esto nunca se imprime")`

Esto ejecuta las `10` iteraciones del bucle, pero la declaración `print` después del `continue` siempre se salta.
