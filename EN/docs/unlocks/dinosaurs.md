...
Every time you move away from an apple the tail of the dinosaur hat will grow by one tile and, if you have enough items, a new apple will be purchased and placed in a random spot.
...
<spoiler=show hint 1>If you keep moving along the same path that covers the whole field, you can easily get a full field snake every time, because you will cover every free spot before you get back to where your tail is. It's not very efficient, but it works.</spoiler>