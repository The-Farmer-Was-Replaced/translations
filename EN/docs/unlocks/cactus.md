...
A cactus is considered to be in sorted order if all neighboring cacti to the `North` and `East` are fully grown and larger or equal to it and all neighboring cacti to the `South` and `West` are fully grown and smaller or equal to it.
